package coreBusiness.delinquencies.lienholderpartialcancel;
...
public class LHPartialCancelThresholdTest extends BaseTest {
	...
	private double lienholderLoanPremiumAmount , downPayment;
	...
	public void payDownPayments_reversePaymentAndCheckForDelinquency() throws Exception {
		...
		Assert.assertTrue(acctDelinquency.verifyDelinquencyByReason(repository.gw.enums.OpenClosed.Open, repository.gw.enums.DelinquencyReason.PastDueLienPartialCancel, myPolicyObj.accountNumber, reversalDate), "Delinquency does not exist Which is not Expected");
