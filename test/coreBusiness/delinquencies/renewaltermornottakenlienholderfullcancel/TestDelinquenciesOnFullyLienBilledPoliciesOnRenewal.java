...
public class TestDelinquenciesOnFullyLienBilledPoliciesOnRenewal extends BaseTest {
	...
	public void MakeInvoiceBilledAndDue() throws Exception {
		...
		invoiceDueDate = repository.gw.helpers.DateUtils.dateAddSubtract(myPolicyObj.squire.getEffectiveDate(), repository.gw.enums.DateAddSubtractOptions.Month, 1);
		...
		//Make Invoice Billed 
		repository.gw.helpers.ClockUtils.setCurrentDates(cf,invoiceBillDate);
		...
		repository.gw.helpers.ClockUtils.setCurrentDates(driver, DateUtils.dateAddSubtract(myPolicyObj.squire.getExpirationDate(), repository.gw.enums.DateAddSubtractOptions.Day, -48));
