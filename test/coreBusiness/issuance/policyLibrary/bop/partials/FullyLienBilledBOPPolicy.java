...
public class FullyLienBilledBOPPolicy extends BaseTest {
    ...
    public void testGenerateFullyLienBilledBOPPolicy() throws  Exception {
        ...
        generatePolicy = new GeneratePolicyHelper(driver).generateFullyLienBilledBOPPolicy(null,null,null,null , generateContacts);
