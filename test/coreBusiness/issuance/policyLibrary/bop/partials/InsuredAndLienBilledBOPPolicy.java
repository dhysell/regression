...
public class InsuredAndLienBilledBOPPolicy  extends BaseTest {

    GeneratePolicy generatePolicy;
    private WebDriver driver;

    @Test
    public void testGenerateInsuredAndLienBilledBOPPolicy() throws  Exception {
        ...
        generatePolicy = new GeneratePolicyHelper(driver).generateInsuredAndLienBilledBOPPolicy(null,null,null,null , generateContacts);
