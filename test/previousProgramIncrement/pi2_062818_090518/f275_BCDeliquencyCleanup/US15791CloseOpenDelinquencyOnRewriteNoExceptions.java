...
public class US15791CloseOpenDelinquencyOnRewriteNoExceptions extends BaseTest {
    ...
    public void generatePolicy() throws Exception {
        ...
        generatePolicy = new GeneratePolicy.Builder(driver)
                ...
                .withInsFirstLastName("Rewrite", "CxPol")
    ...
    public void verifyCancellationChargesInBC() throws Exception {
        ...
        new BatchHelpers(cf).runBatchProcess(BatchProcess.Invoice);
        repository.gw.helpers.ClockUtils.setCurrentDates(cf, DateAddSubtractOptions.Day, 3);
    ...
    public void rewritePolicy() throws Exception {
        ...
        new Login(driver).loginAndSearchPolicyByPolicyNumber(this.arUser.getUserName(), this.arUser.getPassword(), generatePolicy.squire.getPolicyNumber());
            ...
            new StartRewrite(driver).rewriteRemainderOfTerm(generatePolicy);
