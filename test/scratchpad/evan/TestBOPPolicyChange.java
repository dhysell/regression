...
public class TestBOPPolicyChange extends BaseTest {
    ...
    private void testValidateCostChangeDetailsBOP() throws Exception {
        Config cf = new Config(ApplicationOrCenter.PolicyCenter);
        driver = buildDriver(cf);
        new Login(driver).loginAndSearchAccountByAccountNumber(bopPolicyObj.underwriterInfo.getUnderwriterUserName(),
        ...
        bopAddCov.fillOutBusinessownersLinePages(true, bopPolicyObj.busOwnLine);
