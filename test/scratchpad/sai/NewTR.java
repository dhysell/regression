...
public class NewTR extends BaseTest {
...
Config cf = new Config(ApplicationOrCenter.PolicyCenter);
        ...
        new Login(driver).loginAndSearchAccountByAccountNumber("bswindle", "gw", "049694");
        ...
        polInfo.setPolicyInfoEffectiveDate(DateUtils.dateFormatAsString("MM/dd/yyyy", DateUtils.dateAddSubtract(DateUtils.getCenterDate(driver, ApplicationOrCenter.PolicyCenter), DateAddSubtractOptions.Day, 0)));
