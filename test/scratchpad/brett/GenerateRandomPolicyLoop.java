...
public class GenerateRandomPolicyLoop extends BaseTest {
...
*/
    @Test()
    public void generateRandomPolicy() throws Exception {
        generatePolicy(4, 1, 1, null, null, false, false, false);
    }//END TEST
...
//														this.add(ParkingLotSidewalkCharacteristics.NoneOfAbove);
                ...
                myPolicy = new GeneratePolicy.Builder(driver)
                        ...
                        .withInsPersonOrCompanyRandom(("Return" + i), "Premium", "Return Premium" + i)
