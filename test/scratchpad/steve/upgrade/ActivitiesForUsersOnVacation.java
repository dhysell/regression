...
public class ActivitiesForUsersOnVacation extends BaseTest {
    ...
    public void createActivity(AbUsers user) {
    ...
    public void completeActivity() throws Exception {
        ...
        sidebar.clickSidebarActivitySearchLink();

        ActivitySearchAB searchPage = new ActivitySearchAB(driver);
        searchPage.setUserName(vacationUser.getUserName());
        searchPage.clickSearch();

        boolean activitiesExist = searchPage.checkActivitiesExist();
        if (activitiesExist) {
