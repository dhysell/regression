 ...
 * @DATE Feb 15, 2017
 */
public class TestPLActionRenewalOptionAvailability extends BaseTest {
    private GeneratePolicy mySquirePolObjBefore80;
    ...
    public void testIssueSquirePolicyBefore80Days() throws Exception {
        ...
        new Login(driver).loginAndSearchPolicyByPolicyNumber(uw.getUnderwriterUserName(), uw.getUnderwriterPassword(), mySquirePolObjBefore80.squire.getPolicyNumber());
...
//        //        // Login with UW
//        uw = UnderwritersHelper.getUnderwriterInfoByLineAndTitle(Underwriter.UnderwriterLine.Personal, Underwriter.UnderwriterTitle.Underwriter);
//        loginAndSearchPolicyByPolicyNumber(uw.getUnderwriterUserName(), uw.getUnderwriterPassword(), mySquirePolObjAt80.squire.getPolicyNumber());
//
//        //        PolicyMenu policyMenu = new PolicyMenu(driver);
//        if (!policyMenu.checkRenewPolicyOption()) {
