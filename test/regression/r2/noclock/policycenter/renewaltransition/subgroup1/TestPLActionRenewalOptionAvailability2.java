 ...
 * @DATE Feb 15, 2017
 */
public class TestPLActionRenewalOptionAvailability2 extends BaseTest {
    private GeneratePolicy mySquirePolObjAfter80;
...
//    }
    ...
    public void testIssueSquirePolicyAfter80Days() throws Exception {
        ...
        // Login with UW
        uw = UnderwritersHelper.getUnderwriterInfoByLineAndTitle(Underwriter.UnderwriterLine.Personal, Underwriter.UnderwriterTitle.Underwriter);
        new Login(driver).loginAndSearchPolicyByPolicyNumber(uw.getUnderwriterUserName(), uw.getUnderwriterPassword(), mySquirePolObjAfter80.squire.getPolicyNumber());
...
//        gw.newDriver.Config cf = new gw.newDriver.Config(ApplicationOrCenter.PolicyCenter);
//driver = buildDriver(cf);
//
//        SquireLiability myLiab = new SquireLiability();
//        myLiab.setGeneralLiabilityLimit(SectionIIGeneralLiabLimit.Limit_50_100_25);
