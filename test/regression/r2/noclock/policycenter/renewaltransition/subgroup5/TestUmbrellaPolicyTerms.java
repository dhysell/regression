...
@QuarantineClass
public class TestUmbrellaPolicyTerms extends BaseTest {
    ...
    public void testIssueUnderLyingSquire() throws Exception {
        ...
        new Login(driver).loginAndSearchPolicyByAccountNumber(uw.getUnderwriterUserName(), uw.getUnderwriterPassword(), mySquireUmbrellaPol.accountNumber);
    ...
    private void testValidateUmbrellaDetails() throws Exception {
        ...
        sideMenu.clickSideMenuPolicyInfo();
        System.out.println(DateUtils.dateFormatAsString("MM/dd/yyyy", policyInfo.getPolicyInfoExpirationDate()));
        System.out.println(policyInfo.getUnderlyingPolicyNumber());
        System.out.println(policyInfo.getUnderlyingPolicyJobNumber());
        System.out.println(policyInfo.getAdditionalInsuredName(1, "Name"));
