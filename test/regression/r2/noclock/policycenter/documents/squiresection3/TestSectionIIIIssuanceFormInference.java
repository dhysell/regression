...
@QuarantineClass
public class TestSectionIIIIssuanceFormInference extends BaseTest {
	private WebDriver driver;
	private GeneratePolicy myPolicyObjPL;
	private String insFirstName = "Issuance";
	...
	private void testIssueSectionIIIWithForms() throws Exception {
		...
		this.eventsHitDuringSubmissionCreationPlusLocal.add(DocFormEvents.PolicyCenter.Squire_Auto_StandardAutoPolicyDeclarations);
		...
		GenericWorkorderSquireAutoCoverages_AdditionalCoverages aditionalcoverages = new GenericWorkorderSquireAutoCoverages_AdditionalCoverages(driver);
		aditionalcoverages.setAccidentalDeath(true);

		// UW I323 10 14 Drive Other Car
		aditionalcoverages.setDriveOtherCar(true);
		...
		this.eventsHitDuringSubmissionCreationPlusLocal.add(DocFormEvents.PolicyCenter.Squire_Auto_AdditionalInsuredEndorsement);
		...
		this.eventsHitDuringSubmissionCreationPlusLocal.add(DocFormEvents.PolicyCenter.Squire_Auto_ModificationInsuredVehicle);
		...
		this.eventsHitDuringSubmissionCreationPlusLocal.add(DocFormEvents.PolicyCenter.Squire_Auto_InsuredVehicleLeasingEndorsement);
		...
		this.eventsHitDuringSubmissionCreationPlusLocal.add(DocFormEvents.PolicyCenter.Squire_Auto_AdditionalLivingExpense);
		...
		this.eventsHitDuringSubmissionCreationPlusLocal.add(DocFormEvents.PolicyCenter.Squire_Auto_DeletionMaterialDamage);
		...
		this.eventsHitDuringSubmissionCreationPlusLocal.add(DocFormEvents.PolicyCenter.Squire_Auto_ShowCarDriverExclusion);
		
		
		this.eventsHitDuringSubmissionCreationPlusLocal.add(DocFormEvents.PolicyCenter.Squire_Auto_ClassicCarLimitationCoverage);
	...
	private void testValidateSectionIIIDocuments() throws Exception {
		...
		String[] documents = { "Classic Car Limitation of Coverage Endorsement", "Certificate of Liability Insurance",
				"Additional Interest Declarations", "Automobile Policy Booklet", "Standard Auto Policy Declarations",
				"Notice of Policy on Privacy","Adverse Action Letter", "Definition Endorsement", "Show Car Driver Exclusion Endorsement",
