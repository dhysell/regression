...
@QuarantineClass
public class TestSectionIIIPolicyChangeFormInference extends BaseTest {
	...
	public void testPolicyChangeAddSectionIIICoverages() throws Exception {
		...
		this.eventsHitDuringSubmissionCreationPlusLocal
		.add(DocFormEvents.PolicyCenter.Squire_Auto_DriveOtherCar);
		...
		this.eventsHitDuringSubmissionCreationPlusLocal
		.add(DocFormEvents.PolicyCenter.Squire_Auto_SpecialEndorsement);
		...
		this.eventsHitDuringSubmissionCreationPlusLocal
		.add(DocFormEvents.PolicyCenter.Squire_Auto_DriverExclusion);
	...
	@Test(dependsOnMethods = { "testPolicyChangeAddSectionIIICoverages" })
	private void testValidateSectionIIIDocuments() throws Exception {
		...
		String[] documents = { "Classic Car Limitation of Coverage Endorsement", "Certificate of Liability Insurance",
				...
				"Definition Endorsement", "Show Car Driver Exclusion Endorsement",
