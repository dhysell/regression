 ...
 */
@QuarantineClass
public class TestStdIMRewriteNewTerm extends BaseTest {
    ...
    public void testStdIMNewTermForms() throws Exception {
        ...
        login.loginAndSearchPolicyByPolicyNumber(uw.getUnderwriterUserName(), uw.getUnderwriterPassword(), stdIMPolObj.standardInlandMarine.getPolicyNumber());
...
//		//		policyMenu.clickRewriteNewTerm();
    ...
    @Test(dependsOnMethods = {"testStdIMNewTermForms"})
    private void testValidateStdIMNewTermDocuments() throws Exception {
        Config cf = new Config(ApplicationOrCenter.PolicyCenter);
        driver = buildDriver(cf);
        ...
        String[] documents = {"Special Endorsement for Inland Marine", "Farm Equipment Endorsement (Named Perils)", "Farm Equipment Endorsement Schedule (Named Perils)",
                ...
                "Personal Lines Application", "Notice of Policy on Privacy"};
