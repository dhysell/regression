 ...
 * @DATE Mar 23, 2017
 */
public class TestStdIMIssuanceFormInference extends BaseTest {
    ...
    private void testStdIMIssuanceDocuments() throws Exception {
        Config cf = new Config(ApplicationOrCenter.PolicyCenter);
        driver = buildDriver(cf);
        ...
        String[] documents = {"Special Endorsement for Inland Marine", "Farm Equipment Endorsement (Named Perils)", "Farm Equipment Endorsement Schedule (Named Perils)",
                ...
                "Inland Marine Policy Booklet", "Notice of Policy on Privacy"};
