 ...
 */
@QuarantineClass
public class TestSectionIVIssuanceFormInference extends BaseTest {
	...
	@Test
	public void testFormInference_GenerateBound() throws Exception {
	...
	@Test (dependsOnMethods = { "testFormInference_GenerateBound" })
...
//		propertyLocations.selectRangeDirection(townshipRange.getRangeDirection());
	...
	private void testSquireIMIssuanceDocuments() throws Exception {
		Config cf = new Config(ApplicationOrCenter.PolicyCenter);
		driver = buildDriver(cf);
