 ...
 */
@QuarantineClass
public class TestUmbrellaRewriteFullTermFormInference extends BaseTest {
    ...
    private void testSquireRewriteFullTermAddCoverages() throws Exception {
        ...
        rewritePage.rewriteFullTermGuts(squireFullApp);
    ...
    @Test(dependsOnMethods = {"testSquireRewriteFullTermAddCoverages"})
    private void testUmbrellaRewriteFullTermAddCoverages() throws Exception {
    ...
    @Test(dependsOnMethods = {"testUmbrellaRewriteFullTermAddCoverages"})
