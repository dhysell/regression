 ...
 * @DATE Mar 29, 2016
 */
public class TestStandardFireIssuanceFormsInference extends BaseTest {
	...
	@Test
	public void testCreateSFireBound() throws Exception {
	...
	@Test (dependsOnMethods = { "testCreateSFireBound" })
	public void testStdFireIssuanceForms() throws Exception {
		...
		new Login(driver).loginAndSearchPolicyByAccountNumber(uw.getUnderwriterUserName(), uw.getUnderwriterPassword(),stdirePolObj.accountNumber);
	...
	private void testStdFireIssuanceDocuments() throws Exception {
		Config cf = new Config(ApplicationOrCenter.PolicyCenter);
		driver = buildDriver(cf);
		...
		boolean testFailed = false;		String errorMessage = "Account Number: " + stdirePolObj.accountNumber;
	...
	private void testStdFireTrellisedHopsIssuanceDocuments() throws Exception {
		Config cf = new Config(ApplicationOrCenter.PolicyCenter);
		driver = buildDriver(cf);
