 ...
 * @DATE Apr 12, 2017
 */
public class TestSectionICancellationReinstateFormInference extends BaseTest {
    ...
    private void testIssueSquireWithSectionICoverages() throws Exception {
        ...
        if (mySqSectionIFRPol.squire.squireEligibility.equals(SquireEligibility.Country) || mySqSectionIFRPol.squire.squireEligibility.equals(SquireEligibility.FarmAndRanch)) {
            ...
            householdMember.setSSN("1" + StringsUtils.generateRandomNumberDigits(8).replace("00", "78"));
    ...
    public void testInitiateCancellation() throws Exception {
        ...
        testValidateSectionIDocuments("Cancel");

    }

    @Test(dependsOnMethods = {"testInitiateCancellation"})
    private void testReinstateSectionICoverages() throws Exception {
        ...
        testValidateSectionIDocuments("Reinstate");
    }


    private void testValidateSectionIDocuments(String type) throws Exception {
        Config cf = new Config(ApplicationOrCenter.PolicyCenter);
        driver = buildDriver(cf);
