 ...
 */
@QuarantineClass
public class TestSectionIRewriteNewTermFormInference extends BaseTest {
	...
	public void testInitiateRewriteNewTerm() throws Exception {
		Config cf = new Config(ApplicationOrCenter.PolicyCenter);
		driver = buildDriver(cf);
	...
	@Test(dependsOnMethods = { "testInitiateRewriteNewTerm" })
	private void testRewriteNewTermAddSectionICoverages() throws Exception {
...
//		policyMenu.clickRewriteNewTerm();
	...
	@Test(dependsOnMethods = { "testRewriteNewTermAddSectionICoverages" })
