 ...
 * @DATE Jul 25, 2016
 */
public class TestPLOutOfSequencePolicyChange3 extends BaseTest {
	private WebDriver driver;
    private GeneratePolicy myUmbSqPol;
...
//     */
//    @Test()
//    private void testIssueStandardLiabilityPolicy() throws GuidewirePolicyCenterException, Exception {
//        Configuration.setProduct(ApplicationOrCenter.PolicyCenter);
//        ArrayList<PolicyLocation> locationsList = new ArrayList<PolicyLocation>();
//        ArrayList<PLPolicyLocationProperty> locOnePropertyList = new ArrayList<PLPolicyLocationProperty>();
