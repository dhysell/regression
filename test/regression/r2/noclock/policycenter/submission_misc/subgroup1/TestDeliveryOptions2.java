 ...
 * @DATE Oct 03, 2017
 */
public class TestDeliveryOptions2 extends BaseTest {
    private Underwriters uw;
    private GeneratePolicy myStdFireObj;
...
//    }
    ...
    public void testGenerateStdFireFullApp() throws Exception {
        ...
        property1.getPropertyCoverages().getCoverageE().setCoverageType(CoverageType.Peril_1);
    ...
    public void validateDeliveryOption(GeneratePolicy pol) throws Exception {
        ...
        new Login(driver).loginAndSearchJob(uw.getUnderwriterUserName(), uw.getUnderwriterPassword(), pol.accountNumber);
        ...
        if (!new ErrorHandlingHelpers(driver).getErrorMessage().contains("Please add/remove the following Delivery Options [Attention]"))
...
//        loginAndSearchJob(pol.agentInfo.getAgentUserName(), pol.agentInfo.getAgentPassword(), pol.accountNumber);
//        SideMenuPC sideMenu = new SideMenuPC(driver);
//
//        editPolicyTransaction();
