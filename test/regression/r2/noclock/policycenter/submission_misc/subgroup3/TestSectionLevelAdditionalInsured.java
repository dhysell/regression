 ...
 * @DATE Aug 23, 2016
 */
public class TestSectionLevelAdditionalInsured extends BaseTest {
    private GeneratePolicy myPolicyObj;
    private String randFirst = StringsUtils.generateRandomNumberDigits(4);
    ...
    public void verifyCountWhenIsThatTrustQuestionIsYes() throws Exception {
        ...
        addressBook.searchAddressBookByCompanyName(myPolicyObj.basicSearch, "BBIT-" + randFirst, "752 2ND AVE", "TWIN FALLS", State.Idaho,
        ...
        newHousehodMember.sendArbitraryKeys(Keys.TAB);
...
//
//		// IM
//		loginAndSearchJob(squire_PolicyObj.agentInfo.getAgentUserName(), squire_PolicyObj.agentInfo.getAgentPassword(),
//				squire_PolicyObj.accountNumber);
//		//		SideMenuPC sideMenu = new SideMenuPC(driver);
//		sideMenu.clickSideMenuIMExclusionsAndConditions();
//		//		sideMenu.clickSideMenuSquireIMLineReview();
//		//
//		GenericWorkorderIMLineReviewPL imLineReview = new GenericWorkorderIMLineReviewPL();
