 ...
 * @DATE Aug 23, 2016
 */
public class TestSectionLevelAdditionalInsured4 extends BaseTest {
...
//
    ...
    public void testCreateStandardFireWithSquire() throws Exception {
        ...
        new Login(driver).loginAndSearchJob(stdFireLiab_Squire_PolicyObj.agentInfo.getAgentUserName(), stdFireLiab_Squire_PolicyObj.agentInfo.getAgentPassword(), stdFireLiab_Squire_PolicyObj.accountNumber);
        SideMenuPC sidebar = new SideMenuPC(driver);
        sidebar.clickSideMenuPolicyReview();
