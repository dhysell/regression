...
public class AutoLiabilityPD_Property extends BaseTest {
    ...
    private String policyNumber = "01-102465-02";
    private String coverageNeeded = "Liability - Auto Property Damage";

    // Exposure Strings. 
    private String exposureType = "Auto Property Damage - Property";
    ...
    // FNOL
    @Test
    public void autoPropertyDamagePropertyFNOL() throws Exception {
    ...
    // Exposure
    @Test(dependsOnMethods = {"autoPropertyDamagePropertyFNOL"})
    public void createExposureCollisionPD() throws Exception {
        Config cf = new Config(ApplicationOrCenter.ClaimCenter);
        driver = buildDriver(cf);
    ...
    // Reserves
    @Test(dependsOnMethods = {"createExposureCollisionPD"})
    public void createReserveCollisionPD() throws Exception {
    ...
    // Checks
    @Test(dependsOnMethods = {"createReserveCollisionPD"})
    public void createCheckCollisionPD() throws Exception {
        Config cf = new Config(ApplicationOrCenter.ClaimCenter);
        driver = buildDriver(cf);
