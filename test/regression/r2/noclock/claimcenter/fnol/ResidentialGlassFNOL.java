...
public class ResidentialGlassFNOL extends BaseTest {
    ...
    private String policyNumber = "01-288627-01";


    @Test
    public void residentialGlassFNOL() throws Exception {
        ...
        GenerateFNOL myFNOLObj = new GenerateFNOL.Builder(driver).withCreatorUserNamePassword(user.toString(), password)
                ...
                .build(GenerateFNOLType.ResidentialGlass);
