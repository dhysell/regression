package regression.r2.clock.billingcenter.delinquency.testdelinquencies.renewaltermornottakenlienholderpartialcancel;
 ...
 * @DATE May 12, 2017
 */
public class NotTakenLHPartialCancelThresholdTest extends BaseTest {
    ...
    public void generatePolicy() throws Exception {
        ...
        myPolicyObj = new GeneratePolicyHelper(driver).generateInsuredAndLienBilledBOPPolicy("LH NTkn Threshold",120, repository.gw.enums.PaymentPlanType.Annual, repository.gw.enums.PaymentType.Cash , generateContacts);
    ...
    public void reversePaymentMadeOnDownPaymentAndCheckForDelinquency() throws Exception {
        ...
        Assert.assertTrue(acctDelinquency.verifyDelinquencyStatus(repository.gw.enums.OpenClosed.Open, this.lienholderNumber, myPolicyObj.busOwnLine.getPolicyNumber(), reversalDate), "Delinquency does not exist Which is not Expected");
        orgDelinquentAmount = acctDelinquency.getOriginalDelinquentAmount(repository.gw.enums.OpenClosed.Open, this.lienholderNumber, myPolicyObj.busOwnLine.getPolicyNumber(), reversalDate);
