package regression.r2.clock.billingcenter.delinquency.testdelinquencies.insuredpartialcancel;
...
public class InsuredPartialCancelThresholdTest extends BaseTest {
	...
	public void generatePolicy() throws Exception {
		...
		myPolicyObj = new GeneratePolicyHelper(driver).generateInsuredAndLienBilledBOPPolicy("ThresholdTestIns",null, repository.gw.enums.PaymentPlanType.Quarterly, repository.gw.enums.PaymentType.Cash , generateContacts);
    ...
    public void reversePaymentMadeOnDownPaymentAndCheckForDelinquency() throws Exception {
        ...
        payment = new AccountPayments(driver);
        payment.reversePayment(myPolicyObj.busOwnLine.getPremium().getDownPaymentAmount(), null, null, repository.gw.enums.PaymentReversalReason.Payment_Moved);
