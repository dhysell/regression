...
public class TestDelinquenciesOnFullyLienBilledPoliciesOnRenewal extends BaseTest {
	...
	public void MakeInvoiceBilledAndDue() throws Exception {
		...
		invoiceDueDate = DateUtils.dateAddSubtract(myPolicyObj.squire.getEffectiveDate(), DateAddSubtractOptions.Month, 1);
		...
		//Make Invoice Billed 
		ClockUtils.setCurrentDates(cf,invoiceBillDate);
