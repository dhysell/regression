...
import regression.r3.noclock.policycenter.generalliability.GLExposureUWQuestionsNext;

public class GLExposureUWQuestions_FA_Next extends GLExposureUWQuestionsNext {
     ...
     * @Description Test All Questions requited at FA with associated User Validations
     * @DATE Jun 8, 2016
     */
    @Test
    public void validateUWExposureQuestionsFA() throws Exception {
        ...
        validateUWQuestions(myPolicyObj, setExposureClasscodes());
