...
public class Property extends BaseOperations {
    ...
    public void propertyFNOL() {
        ...
        interact.withTexbox(CCIDs.Claim.SearchOrCreatePolicy.PROPERTY).click();
        ...
        interact.withTexbox(CCIDs.Claim.AddClaimInformation.LOSS_DESCRIPTION).fill("Property Test.");
