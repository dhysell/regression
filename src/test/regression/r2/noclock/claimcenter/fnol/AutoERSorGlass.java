...
public class AutoERSorGlass extends BaseOperations {
    ...
    public void firstNoticeOfLoss() {
        ...
        interact.withTexbox(CCIDs.Claim.SearchOrCreatePolicy.AUTO_ERS_OR_GLASS).click();
        ...
        interact.withTexbox(CCIDs.Claim.AutoERSorGlass.LOSS_DESCRIPTION).fill("ERS or Glass Test.");
        interact.withSelectBox(CCIDs.Claim.AutoERSorGlass.LOSS_CAUSE).select("Auto Glass-Windshield");
        interact.withElement(CCIDs.Claim.AutoERSorGlass.REPAIR_YES).click();
