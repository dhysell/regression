...
public class InlandMarine extends BaseOperations {
    ...
    public void firstNoticeOfLoss() {
        ...
        interact.withTexbox(CCIDs.Claim.SearchOrCreatePolicy.INLAND_MARINE).click();
        ...
        interact.withTexbox(CCIDs.Claim.AddClaimInformation.LOSS_DESCRIPTION).fill("Inland Marine Test.");
        interact.withSelectBox(CCIDs.Claim.AddClaimInformation.LOSS_CAUSE).select("Explosion");
