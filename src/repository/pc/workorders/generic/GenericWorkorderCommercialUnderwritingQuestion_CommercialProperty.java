...
public class GenericWorkorderCommercialUnderwritingQuestion_CommercialProperty extends BasePage {

    private TableUtils tableUtils;
    private WebDriver driver;

    public GenericWorkorderCommercialUnderwritingQuestion_CommercialProperty(WebDriver driver) {
        super(driver);
        this.driver = driver;
    ...
    private void setCPTextBoxQuestion(CPPCPClassCodeUWQuestions question) {
        ...
        if (question.isDependantQuestion()) {
            textElement = (find(By.xpath("//div[contains(text()," + StringsUtils.xPathSpecialCharacterEscape(question.getDependentOnQuestion().getQuestionLabel()) + ")]/ancestor::tr/following-sibling::tr/descendant::div[contains(text()," + StringsUtils.xPathSpecialCharacterEscape(question.getQuestionLabel()) + ")]/ancestor::table/parent::div/parent::div/following-sibling::div//*[@name='c2']")));
        } else {
            textElement = (find(By.xpath("//div[contains(text()," + StringsUtils.xPathSpecialCharacterEscape(question.getQuestionLabel()) + ")]/ancestor::table/parent::div/parent::div/following-sibling::div//*[@name='c2']")));
        }
    ...
    private void setCPDateQuestion(CPPCPClassCodeUWQuestions question) {
        ...
        WebElement textElement = find(By.xpath("//div[contains(text(), '" + question.getQuestionText() + "')]/ancestor::table/parent::div/parent::div/following-sibling::div//*[@name='c2']"));
        textElement.sendKeys(Keys.chord(Keys.CONTROL + "a"));
    ...
    private void setCPRadioQuestion(CPPCPClassCodeUWQuestions question) {
        ...
        WebElement questionsTable = find(By.xpath("//label[contains(text(), " + StringsUtils.xPathSpecialCharacterEscape(question.getClassCodeName().replace("�", "-")) + ")]/ancestor::tr/following-sibling::tr/descendant::div[contains(@id, 'CPBuildingClassCodelQuestionsPanelSet')]"));
        String questionDependentOnText = (question.isDependantQuestion()) ? question.getDependentOnQuestion().getQuestionText() : null;

        tableUtils.setRadioValueForCellInsideTable(questionsTable, questionDependentOnText, question.getQuestionText(), question.getCorrectAnswer().equals("Yes"));
...
//		
    ...
    private void setCPRadioQuestion(CPPCPClassCodeUWQuestions question, boolean yesno) {
        ...
        tableUtils.setRadioValueForCellInsideTable(questionsTable, questionDependentOnText, question.getQuestionText(), yesno);
...
//		}
        ...
        if (question.isDependantQuestion()) {
            tableUtils.setCheckboxInTableByText(questionsTable, question.getQuestionText(), checked);
//			tableUtils.setCheckboxInTableByText(questionsTable, StringsUtils.xPathSpecialCharacterEscape(question.getDependentOnQuestion().getQuestionLabel()), checked);
//			checkbox = find(By.xpath("//div[contains(text()," + StringsUtils.xPathSpecialCharacterEscape(question.getDependentOnQuestion().getQuestionLabel()) + ")]/ancestor::tr/following-sibling::tr/descendant::div[contains(text()," + StringsUtils.xPathSpecialCharacterEscape(question.getQuestionLabel()) + ")]/parent::td/following-sibling::td/div/img"));
        } else {
            tableUtils.setCheckboxInTableByText(questionsTable, question.getQuestionText(), checked);
//			checkbox = find(By.xpath("//div[contains(text()," + StringsUtils.xPathSpecialCharacterEscape(question.getQuestionLabel()) + ")]/parent::td/following-sibling::td/div/img"));
