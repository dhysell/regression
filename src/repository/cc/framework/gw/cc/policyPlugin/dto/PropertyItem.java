...
@XmlType(name = "PropertyItem", namespace = "http://www.idfbins.com/PolicyRetrieveResponse", propOrder = {
        "id",
        "appraisalValue",
        "description",
        "displayName",
...
public class PropertyItem {
    ...
    protected String id;
    @XmlElement(name = "AppraisalValue", namespace = "http://www.idfbins.com/PolicyRetrieveResponse", required = true)
