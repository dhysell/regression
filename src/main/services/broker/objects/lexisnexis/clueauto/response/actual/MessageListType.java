...
@XmlSeeAlso({
    services.broker.objects.lexisnexis.clueauto.response.actual.AttachedProductsType.AttachedProduct.class,
    services.broker.objects.lexisnexis.clueauto.response.actual.ClaimType.ConsumerNarrative.class
})
