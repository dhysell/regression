...
/**
 * <p>Java class for modelNameTypeEnum.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="modelNameTypeEnum">
 ...
 * 
 */
@XmlType(name = "modelNameTypeEnum")
@XmlEnum
public enum ModelNameEnum {
    ...
    public static ModelNameEnum fromValue(String v) {
        for (ModelNameEnum c: ModelNameEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
