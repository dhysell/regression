...
public class GuidewireHelpers extends BasePage {
	...
	public GeneratePolicyType getTypeToGenerate(GeneratePolicy policy) {
		switch (policy.productType) {
		case Businessowners:
	...
	public void setTypeToGenerate(GeneratePolicy policy, GeneratePolicyType type) {
		switch (policy.productType) {
		case Businessowners:
	...
	public void setPolicyType(GeneratePolicy policy, GeneratePolicyType type) {
		switch (policy.productType) {
		case Businessowners:
	...
	public GeneratePolicyType getCurrentPolicyType(GeneratePolicy policy) {
		switch (policy.productType) {
		case Businessowners:
