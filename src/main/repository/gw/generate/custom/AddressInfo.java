...
public class AddressInfo {
    ...
    private AddressType type = AddressType.Mailing;
    ...
    private PhoneType phonePrimary = PhoneType.Business;
    private String phoneSpeedDial = "123456";
    private InternetAddress emailAddress = null;
    private Date validUntil = null;
    private ArrayList<AddressInfoDeliveryOption> deliveryOptionList = new ArrayList<AddressInfoDeliveryOption>();
    ...
    public PhoneType getPhonePrimary() {
        return phonePrimary;
    }
    ...
    public ArrayList<AddressInfoDeliveryOption> getDeliveryOptionList() {
