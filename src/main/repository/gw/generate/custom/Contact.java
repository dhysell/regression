...
//	private boolean hasChanged = false;
	...
	private  PersonSuffix insSuffixName =  PersonSuffix.None;
	private String firstName = "First";
	private String middleName = null;
	private String lastName = "Last-" +  DateUtils.dateFormatAsString("yyMMddHHmmss", new Date()) +  StringsUtils.generateRandomNumberDigits(4);
	...
	private String companyName = "Company-" +  DateUtils.dateFormatAsString("yyMMddHHmmss", new Date()) +  StringsUtils.generateRandomNumberDigits(4);
	
	private  ContactSubType personOrCompany =  ContactSubType.Person;
	private ArrayList< LineSelection> additionalInsuredLines = new ArrayList< LineSelection>();
	...
	private Date dob =  DateUtils.dateAddSubtract(new Date(),  DateAddSubtractOptions.Year, -35);
	...
	private Date licenseYear =  DateUtils.dateAddSubtract(new Date(),  DateAddSubtractOptions.Year, -20);
	private int age = 35; 
	private Date hireDate = new Date();
	private boolean excludedDriver = false;
	private int driverNumber = -1;
	private  DrivingExp drivingExp =  DrivingExp.MoreThan2Years;
	private  DriverType driverType =  DriverType.Primary;
	private String primaryVehicleDriven = "8675309";
	private  VehicleUse vehicleUse =  VehicleUse.NotDriventoWorkorSchool;
	private RelationshipsAB relationshipAB = RelationshipsAB.Spouse;
	private  RelationshipToInsuredPolicyMember relationPolicyMember;
	private  RelationshipToInsured relationToInsured =  RelationshipToInsured.SignificantOther;
	private  RelationshipToInsuredCPP relationshipToInsuredCPP =  RelationshipToInsuredCPP.SignificantOther;
	private  CommuteType commuteType =  CommuteType.WorkFromHome;
	...
	private  HowLongWithoutCoverage withOutCoverage =  HowLongWithoutCoverage.NewDriver;
	private ArrayList< ContactRole> roles = new ArrayList< ContactRole>();
	...
	private  ContactRelationshipToMember contactRelationshipToPNI =  ContactRelationshipToMember.None;
	...
	private  AdditionalInterest membershipDuesLienHolder = null;
	private CountyIdaho membershipDuesCounty = null;
	private  MembershipCurrentMemberDuesStatus membershipDuesCurrentChargeStatus =  MembershipCurrentMemberDuesStatus.Charged;
	private  MembershipRenewalMemberDuesStatus membershipDuesRenewalChargeStatus =  MembershipRenewalMemberDuesStatus.No_Change;
	
	private AddressInfo address = new AddressInfo(true);
	private List<AddressInfo> addressList = new ArrayList<AddressInfo>();

	private  InsuranceScore insuranceScore =  InsuranceScore.NeedsOrdered;
	...
	public Contact(InsuranceScoreTestCases testCase) throws ParseException {
		...
		if(!testCase.getDobasof102017().isEmpty()) {
			this.dob =  DateUtils.convertStringtoDate(testCase.getDobasof102017(), "yyyyMMdd");
		}
	...
	public Contact(PolicyInfoAdditionalNamedInsured aniToCopy) {
		...
		switch (aniToCopy.getRelationshipToPNI()) {
			case Spouse:
				this.contactRelationshipToPNI =  ContactRelationshipToMember.Spouse;
				break;
			case ChildWard:
				this.contactRelationshipToPNI =  ContactRelationshipToMember.Child_Ward;
				break;
			case ParentGuardian:
				this.contactRelationshipToPNI =  ContactRelationshipToMember.Parent_Guardian;
				break;
			default:
				break;
		}
	...
	public Contact(String firstName, String lastName) {
		this.firstName = firstName;
		this.lastName = lastName;
		this.personOrCompany =  ContactSubType.Person;
	}
    ...
    public void setDob(WebDriver driver, Date dob) {
		this.dob = dob;
		try {
            this.age =  DateUtils.getDifferenceBetweenDates(dob,  DateUtils.getCenterDate(driver, ApplicationOrCenter.PolicyCenter), DateDifferenceOptions.Year);
		} catch (Exception e) {
	...
	public  DrivingExp getDrivingExp() {
		return drivingExp;
	}
	...
	public  RelationshipToInsured getRelationToInsured() {
	...
	public  RelationshipToInsuredPolicyMember getRelationPolicyMember(){
	...
	public  RelationshipToInsuredCPP getRelationshipToInsuredCPP() {
	...
	public  ContactSubType getPersonOrCompany() {
		return personOrCompany;
	}

	public void setPersonOrCompany( ContactSubType personOrCompany) {
		this.personOrCompany = personOrCompany;
	}

	public ArrayList< LineSelection> isAdditionalInsured() {
	...
	public  HowLongWithoutCoverage getHowLongWithoutCoverageType(){
	...
	public  ContactRelationshipToMember getContactRelationshipToPNI() {
	...
	public  AdditionalInterest getMembershipDuesLienHolder() {
	...
	public MembershipCurrentMemberDuesStatus getMembershipDuesCurrentChargeStatus() {
	...
	public  MembershipRenewalMemberDuesStatus getMembershipDuesRenewalChargeStatus() {
...
//	}
	...
	public  PersonSuffix getInsSuffixName() {
	...
	public boolean isPerson() {
		return personOrCompany.equals( ContactSubType.Person);
	}
	
	public boolean isCompany() {
		return personOrCompany.equals( ContactSubType.Company);
	}
	
	public ArrayList< ContactRole> getContactRoles(){
		return this.roles;
	}
	
	public void setContactRoles(ArrayList< ContactRole> _roles) {
		this.roles = _roles;
	}
