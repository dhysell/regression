...
public class PolicyInfoAdditionalNamedInsured extends AbstractAdditionalInsured {
	...
	private  CreateNew newContact =  CreateNew.Do_Not_Create_New;
    private  AdditionalNamedInsuredType relationshipToPNI =  AdditionalNamedInsuredType.Affiliate;
    ...
    public PolicyInfoAdditionalNamedInsured(Contact contact) {
    	...
    	this.newContact =  CreateNew.Create_New_Only_If_Does_Not_Exist;
    	this.setCompanyOrPerson( ContactSubType.Person);
    }
	...
	public PolicyInfoAdditionalNamedInsured( ContactSubType companyOrPerson) throws Exception {
	...
	public PolicyInfoAdditionalNamedInsured( ContactSubType companyOrPerson, String companyName,
                                             AdditionalNamedInsuredType relationshipToPNI, AddressInfo address) {
		if (companyOrPerson == null) {
			Assert.fail("CompanyOrPerson Name Cannot be Null");
		}

		if (companyOrPerson !=  ContactSubType.Company) {
	...
	public PolicyInfoAdditionalNamedInsured( ContactSubType companyOrPerson, String personFirstName,
                                            String personLastName,  AdditionalNamedInsuredType relationshipToPNI, AddressInfo address) {
		if (companyOrPerson == null) {
			Assert.fail("CompanyOrPerson Name Cannot be Null");
		}

		if (companyOrPerson !=  ContactSubType.Person) {
	...
	public ContactSubType getCompanyOrPerson() {
		return companyOrPerson;
	}

	public void setCompanyOrPerson( ContactSubType companyOrPerson) {
	...
	public  AdditionalNamedInsuredType getRelationshipToPNI() {
	...
	public  CreateNew getNewContact() {
		return newContact;
	}
