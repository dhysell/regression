...
public class PlayingAroundWithListeners implements ITestListener, ISuiteListener {
    /**
    ...
    public void onStart(ISuite suite) {
        Reporter.log("Test Suite Starting", true);
    ...
    public void onStart(ITestContext context) {
        Reporter.log("Test Class about to start", true);
    }
    ...
    public void onFinish(ITestContext context) {
        Reporter.log("All Tests have ran", true);
    }
}
