...
public class GenericWorkorderSquirePropLiabUmbCoveragesExclusions extends GenericWorkorder {

    private WebDriver driver;
    private TableUtils tableUtils;
    
    public GenericWorkorderSquirePropLiabUmbCoveragesExclusions(WebDriver driver) {
        super(driver);
        this.driver = driver;
    ...
    private void setAdditionalUnderlyingInsuranceUmbrellaEndorsement217PolicyNum(String policyNum) {
        ...
        tableUtils.setValueForCellInsideTable(table_AdditionalUnderlyingInsuranceUmbrellaEndorsement217, "c2", policyNum);
    ...
    private void filloutExclusions(GeneratePolicy policy) {
    ...
    private void filloutConditions(GeneratePolicy policy) throws Exception {
        SquirePropertyLiabilityExclusionsConditions exclusionsAndConditions = policy.squire.propertyAndLiability.propLiabExclusionsConditions;
        ...
        if (exclusionsAndConditions.isVendorAsAdditionalInsuredEndorsement_207()) {
            ...
            new Login(driver).loginAndSearchSubmission(randomUW.getUnderwriterUserName(), randomUW.getUnderwriterPassword(), policy.accountNumber);
        ...
        if (exclusionsAndConditions.isConditionAccessYesEndorsement_209()) {
            ...
            Underwriters randomUW = UnderwritersHelper.getUnderwriterInfoByLineAndTitle(UnderwriterLine.Personal, UnderwriterTitle.Underwriter);
            new Login(driver).loginAndSearchSubmission(randomUW.getUnderwriterUserName(), randomUW.getUnderwriterPassword(), policy.accountNumber);
            repository.pc.workorders.generic.GenericWorkorderSquirePropertyCoverages coverages = new GenericWorkorderSquirePropertyCoverages(driver);
