...
public class SubmissionNewSubmission extends SearchAddressBookPC {

    private WebDriver driver;

    public SubmissionNewSubmission(WebDriver driver) {
        super(driver);
        this.driver = driver;
    ...
    private WebElement link_NewSubmissionsAdvanced; 

    public boolean searchAddressBookByTINSSN(boolean basicSearch, String social, TaxReportingOption ssntin, CreateNew createNew){
    	return searchAddressBookBySSNTIN(true, social, ssntin, createNew);
    }
    ...
    public boolean fillOutFormSearchCreateNewWithoutStamp(boolean basicSearch, ContactSubType insPersonOrCompany, String insLastName, String insFirstName, String middleName, String insCompanyName, String city, State state, String zip) throws Exception {
        ...
        if (insPersonOrCompany == ContactSubType.Company) {
            ...
            found = searchAddressBookByFirstLastName(basicSearch, insFirstName, insLastName, null, city, state, zip, CreateNew.Create_New_Always);
        }
        return found;
    }
    ...
    public void selectAdvancedSearchSubmission(){
    	if(checkIfElementExists(link_NewSubmissionsAdvanced, 3000)) {
    		waitUntilElementIsClickable(link_NewSubmissionsAdvanced);
    		link_NewSubmissionsAdvanced.click();
    	}
    }
}
