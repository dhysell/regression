...
@XmlRootElement(name = "inquiry_history")
public class InquiryHistory {

    protected List<InquiryHistory.Inquiry> inquiry;
     ...
     * {@link InquiryHistory.Inquiry }
     * 
     * 
     */
    public List<InquiryHistory.Inquiry> getInquiry() {
        if (inquiry == null) {
            inquiry = new ArrayList<InquiryHistory.Inquiry>();
        }
        return this.inquiry;
    }
