...
@XmlSeeAlso({
    services.broker.objects.lexisnexis.clueproperty.response.actual.AttachedProductsType.AttachedProduct.class,
        services.broker.objects.lexisnexis.clueproperty.response.actual.ClaimType.ConsumerNarrative.class
})
